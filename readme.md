...
With notepad, edit "run_excel_backup.bat" to point to python.exe (probably just edit the dashes after 'ROAU' in C:\Users\ROAU____\AppData\Local\Python\bin\python.exe)
